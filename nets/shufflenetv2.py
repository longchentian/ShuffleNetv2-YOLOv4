...
# from torch.hub import _log_api_usage_once

__all__ = ["ShuffleNetV2",  "shufflenet_v2_x1_0" ]
...
def _shufflenetv2(arch: str, pretrained: bool, progress: bool, *args: Any, **kwargs: Any) -> ShuffleNetV2:
    ...
    if pretrained:
        state_dict = torch.load('./nets/shufflenetv2_x1_5666bf0f80.pth')
...
if __name__ == "__main__":
    ...
    model = shufflenet_v2_x1_0(pretrained=False).to(device);
